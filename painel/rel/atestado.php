...
<div style="font-size: 15px;">
	<p style="margin-left:60px">Atesto para fins trabalhistas que o Sr(a) <b><?php echo $nome_paciente ?></b> portador do CPF <?php echo $cpf_paciente ?> </p>
	<p>esteve sob cuidados profissionais no dia ___/___/______,  e deverá se afastar de suas atividades pelo período</p> de <b><?php echo $datas ?></b> por motivo de <?php echo $motivo ?>
</div>
