		...
		<table style="width: 100%; border: 0px solid #ccc;">
			<tr>
				...
				<td style="width: 55%; text-align: right; font-size: 9px;padding-right: 10px;">
						<b><big>SOLICITAÇÃO DE EXAME</big></b><br>
...
<br>
		...
		<table id="" style="border-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:10px;">
			<thead>
				...
				<tr >
					...
					<td style="width:5%;border-bottom: : 1px solid #000;"></b>SEXO:</b> </td>
		...
		<div align="left" style="margin-top: 25px; margin-bottom: 10px; border-bottom: 1px solid #000; font-size:12px"><b>EXAMES</b></div>
...
<?php 
$query = $pdo->query("SELECT * FROM exames where paciente = '$id' order by id asc");
